<?php
   ...
   }elseif($_SESSION['tipo_usuario'] == "Medico Basico"){//debemos sumar el nuevo perfil y preguntar para quitar opciones al mostrar - Medico Basico
   ...
   */
   ...
   if($_SESSION['tipo_usuario'] == "Administrador"){
       ...
       $query = 
        ...
        WHERE p.areas_id_area = 1 AND (a.estado_antibiotico = 'CONTINUAR TERAPIA')
              ...
              //fecha 
               ...
               switch ($row['estado_antibiotico']) {
                 ...
                 case 'SUSPENSION':
                   ...
                   $estadoAntibioticoBadge = '<span class="badge badge-danger">SUSPENSIÓN</span>';
                   break;
               ...
               switch ($_SESSION['tipo_usuario']) {//tipo de usuario
                    ...
                    case 'Basico':
                           ...
                           <tr>
                               ...
                               <div>
                                <span data-toggle="tooltip" data-placement="top" title="Agregar nueva día de tratamiento">
                                  <button type="button" class="btn btn-success" onclick="obtenerDatosNuevaDiaTratamiento('.$row['id_paciente'].','.$row['id_tratamiento'].','.$row['id_antibiotico'].')" data-backdrop="static" data-keyboard="false">
                                  <i class="fas fa-pills"></i></button>   
                                </span> 

                                <span data-toggle="tooltip" data-placement="top"
                                  title="Editar datos"><button data-backdrop="static" data-keyboard="false" type="button" class="btn btn-warning" data-toggle="modal" data-target="#myModalActualizarPaciente" onclick="obtenerDatosPacientes('.$row['id_paciente'].','.$row['id_tratamiento'].','.$row['id_antibiotico'].')"><i class="fas fa-pen-square"></i></button>
                                </span>
                          ...
                          $data .= '
                           ...
                           <tr>
                               ...
                               <div>
                                ...
                                <span data-toggle="tooltip" data-placement="top"
                                  title="Dianosticar paciente"><button type="button" class="btn btn-success"  onclick="abrirModalDiagnosticarPaciente('.$row['id_paciente'].','.$row['id_tratamiento'].')" data-backdrop="static" data-keyboard="false"><i class="fas fa-notes-medical"></i></button>
                                </span>

                                <span data-toggle="tooltip" data-placement="top"
                                  title="Dianosticar paciente"><button type="button" class="btn btn-danger"  onclick="abrirModalObservacionMedico('.$row['id_paciente'].','.$row['id_tratamiento'].','.$row['id_antibiotico'].')" data-backdrop="static" data-keyboard="false"><i class="fas fa-comment-dots"></i></button>
                                </span>
                       ...
                       }elseif ($_SESSION['areas_id_area'] == "3") {//preguntamos por laboratorio
                         $data .= '
