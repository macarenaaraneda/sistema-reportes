...
<div class="modal fade" id="myModalFormularioDetallesCentinela">
    <div class="modal-dialog modal-lg" style="width: 600px;">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="formFormularioDetallesCentinela" name="formFormularioDetallesCentinela" method="post">
      ...
      <input disabled name="ac_nombre" class="form-control" id="ac_nombre">
         </div>
         </div>
  <div class="formulario">
  <div class="form-group col-sm-12">              
        <h5>Apellidos:</h5>
      <input disabled name="ac_apellidos" class="form-control" id="ac_apellidos">
    </div>
  </div>
  <div class="formulario">
  <div class="form-group col-sm-12">
    ...
    <h5>Rut:</h5>
      <input disabled name="ac_rut" class="form-control" id="ac_rut">
    </div>
  </div>
            ...
            <div class="formulario"> <!--FECHA OCURRENCIA EVENTO -->
                <div class="form-group col-sm-12">
                    ...
                    <input disabled type="date" name="ac_fecha" id= "ac_fecha" class="form-control">
            ...
            <div class="formulario">  <!--SELECT LUGAR DE OCURRENCIA -->
                                ...
                                <div class="form-group col-sm-12">
                                    ...
                                    <select disabled name="ac_unidad" id= "ac_unidad" class="form-control" >
                                        <option selected >
...
<!-- EVENTOS ADVERSOS -->
                            ...
                            <div class="formulario"> <!--SELECT TIPO DE EVENTO ADVERSO -->
                                <div class="form-group col-sm-12">
                                    ...
                                    <h5> Tipo de evento que se reporta</h5>
                                     <select disabled name="ac_evento" id= "ac_evento" class="form-control">
                                    <option selected >
                            ...
                            <div class="checkbox">
                                 ...
                                 <input disabled type="checkbox" name="ac_dano_paciente" id="ac_dano_paciente">
                               ...
                               <div class="formulario"> <!--SELECT GRAVEDAD DEL DAÑO -->
                                ...
                                <div class="form-group col-sm-12">
                                    ...
                                    <select disabled name="ac_tipo_dano" id= "ac_tipo_dano" class="form-control">
               ...
               <div class="checkbox">
                                 ...
                                 <h5>Se informa a:</h5> 
                                 <input disabled type="checkbox" name="ac_paciente" id="ac_paciente">
                                 <label for="paciente">Paciente</label> 
                                 <input disabled type="checkbox" name="ac_familia" id="ac_familia">
                                 <label for="familia">Familia</label> 
                                 <input disabled type="checkbox" name="ac_acompanante" id="ac_acompanante">
                                 <label for="acompanante">Acompañante</label> 
                                 <input disabled type="checkbox" name="ac_no_informa" id="ac_no_informa">
                  ...
                  <div class="formulario"> 
                        <div class="form-group col-sm-12">
                           ...
                           <textarea disabled cols="50" rows="5" name="ac_comentario" maxlength="250"></textarea>
