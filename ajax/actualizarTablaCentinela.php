...
$data = '<table id="tablaInformesCentinela" class="display table-hover table-bordered  table-condensed"  style="width:100%; margin: 0 auto;">
           ...
           while($row = mysqli_fetch_assoc($result))
           {
            switch ($row['areas_id_area']){
              ...
              <tr>
                  ...
                  <button  type="button" class="btn btn-info"  data-toggle="modal" data-target="#myModalFormularioDetallesCentinela" data-backdrop="static" data-keyboard="false" onclick="obtenerDetallesEventosAnalisisCentinela('.$row['id_evento'].')">
