<?php
  ...
  // si el usuario es administrador muestro la tabla con todos los datos dentro del tr ( fila o celda)
   ...
   if($_SESSION['tipo_usuario'] == "Administrador"){
      $data = '<table id="tablaEventos_incidente" class="display table-hover table-bordered"  style="width:100%; margin: 0 auto;">
       <thead>
  ...
  // SI EL USUARIO ES JEFATURA MUESTRO LO SIGUIENTE:
    ...
    $data = '<table id="tablaEventos_incidente" class="display table-hover table-bordered table-condensed"  style="width:100%; margin: 0 auto;">
       ...
       switch ($_SESSION['areas_id_area']) {
           case '1':
            $query = 
                ...
                WHERE areas_id_area= '1'and tipo='Incidente'
                ORDER BY fecha_creacion DESC";
            break;
            ...
            $query = 
                "SELECT * FROM eventos 
                WHERE areas_id_area= '2' and tipo='Incidente'
                ORDER BY fecha_creacion DESC";
             break;
             ...
             $query = 
                "SELECT * FROM eventos 
                WHERE areas_id_area= '3' and tipo='Incidente'
                ORDER BY fecha_creacion DESC";
              break;
              ...
              $query = 
                "SELECT * FROM eventos 
                WHERE areas_id_area= '4' and tipo='Incidente'
                ORDER BY fecha_creacion DESC";
               break;
               ...
               $query = 
                  "SELECT * FROM eventos 
                    WHERE areas_id_area= '5' and tipo='Incidente'
                    ORDER BY fecha_creacion DESC";
                break;
                ...
                $query = 
                    "SELECT * FROM eventos 
                    WHERE areas_id_area= '6' and tipo='Incidente'
                    ORDER BY fecha_creacion DESC";
                 break;
                 ...
                 $query = 
                     "SELECT * FROM eventos 
                     WHERE areas_id_area= '7' and tipo='Incidente'
                     ORDER BY fecha_creacion DESC";
                  break;
                  ...
                  $query = 
                    "SELECT * FROM eventos 
                    WHERE areas_id_area= '8' and tipo='Incidente'
                    ORDER BY fecha_creacion DESC";
                   break;
                   ...
                   $query = 
                      "SELECT * FROM eventos 
                        WHERE areas_id_area= '9' and tipo='Incidente'
                        ORDER BY fecha_creacion DESC";
                    break;
                    ...
                    $query = 
                        "SELECT * FROM eventos 
                        WHERE areas_id_area= '10' and tipo='Incidente'
                        ORDER BY fecha_creacion DESC";
                     break;
                     ...
                     $query = 
                        "SELECT * FROM eventos 
                        WHERE areas_id_area= '11' and tipo='Incidente'
                        ORDER BY fecha_creacion DESC";
                      break;
                      ...
                      $query = 
                        "SELECT * FROM eventos 
                        WHERE areas_id_area= '12' and tipo='Incidente'
                        ORDER BY fecha_creacion DESC";
                       break;
                       ...
                       $query = 
                          "SELECT * FROM eventos 
                            WHERE areas_id_area= '13' and tipo='Incidente'
                            ORDER BY fecha_creacion DESC";
                        break;
                        ...
                        $query = 
                            "SELECT * FROM eventos 
                            WHERE areas_id_area= '14' and tipo='Incidente'
                            ORDER BY fecha_creacion DESC";
                         break;
                         ...
                         $query = 
                            "SELECT * FROM eventos 
                            WHERE areas_id_area= '15' and tipo='Incidente'
                            ORDER BY fecha_creacion DESC";
                          break;
                          ...
                          $query = 
                            "SELECT * FROM eventos 
                            WHERE areas_id_area= '16' and tipo='Incidente'
                            ORDER BY fecha_creacion DESC";
                           break;
                           ...
                           $query = 
                             "SELECT * FROM eventos 
                                WHERE areas_id_area= '17' and tipo='Incidente'
                                ORDER BY fecha_creacion DESC";
                            break;
                            ...
                            $query = 
                                "SELECT * FROM eventos 
                                WHERE areas_id_area= '18' and tipo='Incidente'
                                ORDER BY fecha_creacion DESC";
                             break;
                             ...
                             $query = 
                                "SELECT * FROM eventos 
                                WHERE areas_id_area= '19' and tipo='Incidente'
                                ORDER BY fecha_creacion DESC";
                              break;
                              ...
                              $query = 
                                "SELECT * FROM eventos 
                                WHERE areas_id_area= '20' and tipo='Incidente'
                                ORDER BY fecha_creacion DESC";
                               break;
